...
def get_group_field(filters):
    mapping = {
        "Item Code": "pri.item_code",
        "Rack": "pri.custom_rack",
        "Colour Code": "pri.custom_colour_code",
        "Weight GSM": "pri.custom_weight_gsm",
        "Width": "pri.custom_width",
    }
    return mapping.get(filters.get("group_by"))
...
def get_data(filters):
    ...
    query = f"""
        SELECT
            ...
            pri.custom_weight_gsm,
            pri.custom_width,
            SUM(pri.custom_net_length) as custom_net_length,
            SUM(pri.custom_rolls) as custom_rolls,
